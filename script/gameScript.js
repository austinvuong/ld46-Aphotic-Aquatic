...
let deck = [
  new Card(Image.ROOM0, AnswerType.STORY, "Warm salutations to our newest intern at Aphotic Aquatic! We hope you're as excited to embark on this two-week journey of discovery as we are to have you. Internship is a great opportunity to learn about species you've never seen or even heard of before in our facility reaching over 5,000 metres under sea level! Or - it would be, if so many of our staff weren't going on leave - we really need you to take care of some of their office fish. You may be on one of the most hadal floors the building has to offer, but we've managed to clear out an old office for you to use during your time here. To start, we'll test how well you take care of your very own goldfish!<br>Taking care of fish isn't hard. If there's one thing we've learned here at Aphotic Aquatic, it's that fish only care about one thing: <b>consistency.</b> It doesn't matter what you feed them, just make sure you <b>remember</b> what it was, and <b>always feed them the same thing</b>!<br><br>Don't let us down.<br><br>- Dr. Abby \"Abyss\" Evans, Senior ResearcherDepartment of Bathypelagic Studies", "<i>\"I think I'll name you Goldie\"</i>"),
